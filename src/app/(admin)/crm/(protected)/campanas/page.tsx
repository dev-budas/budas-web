  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
        ...
        <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-amber-700 mt-0.5">
              ...
              <code className="font-mono bg-amber-100 px-1 rounded">META_ADS_ACCESS_TOKEN</code> en las variables de entorno de Vercel.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <StatCard
          label="Gasto total"
          value={fmtEur(summary.spend)}
          icon={Euro}
          color="#1B3A5C"
        />
        <StatCard
          label="Leads generados"
          value={fmtN(summary.leads)}
          icon={Users}
          color="#10B981"
        />
        <StatCard
          label="Coste por lead"
          value={summary.leads > 0 ? fmtEur(summary.cpl) : "—"}
          icon={TrendingUp}
          color="#C9A96E"
        />
        <StatCard
